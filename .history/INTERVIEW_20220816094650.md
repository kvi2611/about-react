...
# promise được sinh ra để xử lý bất đồng bộ, callback là hàm được truyền qua hàm khác dưới dạng đối số, async/await thực chất là promise nhưng cách viết của nó sẽ giúp h
